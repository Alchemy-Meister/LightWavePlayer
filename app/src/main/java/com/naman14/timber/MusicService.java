...
import com.naman14.timber.widgets.BluetoothConnector;
...
public class MusicService extends Service {
    ...
    public boolean connectToDevice(BluetoothDevice device, boolean secure, List<ParcelUuid> candidates)
    {
        ...
        if(candidates != null && candidates.size() > 0) {
            ...
            for (ParcelUuid parcelUuid : candidates) {
                if (parcelUuid != null) {
                    uuidCandidates.add(parcelUuid.getUuid());
                }
            }
        }
        if(socket != null) {
...
//            }
    ...
    private static final class ServiceStub extends ITimberService.Stub {
        ...
        @Override
        public boolean isDeviceConnected(String address) throws RemoteException {
            return mService.get().isDeviceConnected(address);
        }
